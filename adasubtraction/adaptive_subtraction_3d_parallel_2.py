...
def adaptive_subtraction_3d_parallel(data, multiples, nfilt, solver, solver_dict, nwin=(30,150), clipping=False, multiple_filters=False):
    ...
    for shot_num in range(ns):
        ...
        primary_est, multiple_est, filts_est = adaptive_subtraction_2d_parallel(data[shot_num], multiples[shot_num], nfilt, solver,
                                                                     solver_dict, nwin=nwin, clipping=clipping, multiple_filters=multiple_filters)
